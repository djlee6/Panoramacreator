...
imagepath = '/Users/Danny/Downloads/CS534_HW4/MATLAB/input_images';   % Assumes images are in order and are the *only*
                        % files in this directory.
out_dir = '/Users/Danny/Downloads/CS534_HW4/MATLAB/output_images';
%%======================================================================
...
H_map{1} = eye(3);
H_map{2} = H_list{1};
H_map{3} = H_list{1} * H_list{2};
H_map{4} = H_list{1} * H_list{2} * H_list{3};
...
imwrite(panorama_image, fullfile(out_dir, 'djlee6.jpg'));
%------------- YOUR CODE ENDS HERE -----------------
